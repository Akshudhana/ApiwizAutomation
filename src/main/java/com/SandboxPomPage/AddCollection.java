...
//	private WebElement sandboxModuleElement;
    ...
    @FindBy(xpath = "//div[text()='Environment']/ancestor::div[@class='form__input border-bottom-stroke-subsection-1px flex-row w-100 text-left flex-center br-5px false']/descendant::div[@class='css-1wy0on6']")
    private WebElement environmentDropDownInWorkflow;
    

//    @FindBy(xpath = "//div[@title='AWS_SQL_NAME']/ancestor::div[@class='ps-px flex-row vt-center gap-6px max-w-60']/descendant::div[@class='fs-12px fw-500 color-text-regular text-truncate-1 flex-row vt-center gap-6px']")
//	private WebElement 
...
//	}
    ...
    public WebElement getEnvironment(WebDriver driver, String envName) {
    	return driver.findElement(By.xpath("//div[text()= '" + envName + "' ]"));
    }
	...
	public void CreateWorkflowByAddingEnvironment(WebDriver driver,String workflowName,String URL,String envName) throws InterruptedException {
		Random random=new Random();
	    int ran=random.nextInt(1000);
	   ...
	   String urlwithrandomnumber = URL+"_"+ran;
		...
		Thread.sleep(3000);
		environmentDropDownInWorkflow.click();
		
		Thread.sleep(3000);
		getEnvironment(driver, envName).click();
