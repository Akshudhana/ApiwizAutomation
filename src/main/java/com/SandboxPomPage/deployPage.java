...
public class deployPage {
	...
	private WebElement StageVertualHostNameSelect;
	

	@FindBy(xpath = "//div[text()='acme-team-production']")
	private WebElement ProdVertualHostNameSelect;
	...
	public WebElement getVertualHostNameSelect() {
		return StageVertualHostNameSelect;
	}

	public WebElement getProdVertualHostNameSelect() {
		return ProdVertualHostNameSelect;
	}
	...
	public void StageDeployTheWorkflow(WebDriver driver) throws InterruptedException {
		...
		actions.moveToElement(Deploy).click().perform();
		 ...
		 Thread.sleep(3000);
		 StageVertualHostNameSelect.click();
	...
	public void ProdDeployTheWorkflow(WebDriver driver) throws InterruptedException {
		Actions actions = new Actions(driver);
		actions.moveToElement(Deploy).click().perform();
		 ...
		 Thread.sleep(3000);
		 ProdVertualHostNameSelect.click();
