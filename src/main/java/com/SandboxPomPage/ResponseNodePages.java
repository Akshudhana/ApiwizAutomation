...
//		@FindBy(xpath = "//div[text()='Type']/ancestor::div[@class='flex-center gap-6px']/descendant::div[@class='css-1wy0on6']")
	   ...
	   public void AddResponseNode(WebDriver driver,String Response) throws InterruptedException {
		   ...
		   actions.moveToElement(responseBodyPayloadTextFieldElement).click().sendKeys(Response).perform();
